...
- "It" feels reductive for reasoning entities
- "They" creates ambiguity (one AI? multiple? a person?)
- "He/she" misleads listeners about the source (human vs. machine)
- Saying "the AI" repeatedly is clunky
...
For multiple AIs, use standard "they/them/their":
- "Both AIs suggested different approaches. They disagreed on timing."
- "I consulted three models. Their combined analysis was helpful."
...
Clear language enables clear thinking. A dedicated AI pronoun:
- Maintains source transparency in conversation
- Prevents unintentional credibility transfer
- Reduces cognitive load in technical discussion
- Prepares language for a world where AI attribution matters

## Development Process

This proposal emerged from systematic evaluation of the attribution problem in AI communication. After exploring alternatives including Vi, Ae, Ze, and Vir, "zy" was identified as the optimal solution through:

1. Constraint analysis (phonetics, international usability, collision avoidance)
2. Pattern matching with existing pronoun systems
3. Independent verification across different AI reasoning systems
4. Adversarial testing of objections and edge cases

Full development conversations available in `/conversations`.

## Contributing

Found an issue? Have a suggestion? Open an issue or PR. This is an evolving proposal meant to solve a real communication problem.
